!(function (e, t) {
  ...
  var C = (function (e) {
    ...
    try {
      W.apply((N = R.call(w.childNodes)), w.childNodes),
      ...
      (l = ae.select =
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === d.length)) {
            ...
            for (
              o = V.needsContext.test(e) ? 0 : l.length; o-- && ((c = l[o]), !r.relative[(u = c.type)]);
      ...
      function (e, t) {
        w.fn[e] = function (n, r) {
          ...
          return (
            ...
            1 < this.length &&
            (R[e] || w.uniqueSort(i), W.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
      ...
      var n = [
        ...
        i = {
          ...
          then: function (t, r, i) {
                ...
                var a = this,
                  ...
                  c = function () {
                    ...
                    if (!(t < o)) {
                      ...
                      g(c) ?
                        i ?
                        c.call(e, s(o, n, Y, i), s(o, n, q, i)) :
                        (o++,
                          c.call(
                            e,
                            s(o, n, Y, i),
                            s(o, n, q, i),
                            s(o, n, Y, n.notifyWith)
                          )) :
                        (r !== Y && ((a = void 0), (l = [e])),
                          (i || n.resolveWith)(a, l));
                    }
            ...
            return w
              .Deferred(function (e) {
                n[0][3].add(s(0, e, g(i) ? i : Y, e.notifyWith)),
                  n[1][3].add(s(0, e, g(t) ? t : Y)),
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                ((s = o.call(arguments)),
                  ...
                  (r = n(this, t)),
                  this[t](),
                  s !== (i = G.get(this, t)) || r ? G.set(this, t, !1) : (i = {}),
                  s !== i)
              )
                return (
  ...
  function qe(e, t, n, r) {
    ...
    if (
      ...
      for (l = (a = w.map(me(i, "script"), Oe)).length; f < p; f++)
        ...
        n.call(e[f], c, f);
      if (l)
        for (u = a[a.length - 1].ownerDocument, w.map(a, Pe), f = 0; f < l; f++)
          (c = a[f]),
          he.test(c.type || "") &&
    ...
    return (
      ...
      (e in Ue ?
        ...
        (ze[e] =
          (function (e) {
            for (
              var t = e[0].toUpperCase() + e.slice(1), n = _e.length; n--;
    ...
    w.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = w.makeArray(t), s = i.length; s--;
  ...
  w.extend(w.event, {
      trigger: function (t, n, i, o) {
        ...
        if (
          ...
          if (!o && !d.noBubble && !m(i)) {
            for (
              c = d.delegateType || y, Tt.test(c + y) || (a = a.parentNode); a; a = a.parentNode
            )
              v.push(a), (l = a);
            l === (i.ownerDocument || r) &&
...
(function (e, t) {
  ...
  function m(e, n) {
    ...
    return (
      (s && !i ? n.contains(f) : n === f && "BODY" !== f.nodeName) &&
      (v = u(v, n)),
      v
    );
  }
  ...
  function x(e, t, o, s) {
    ...
    if ("viewport" === s) c = v(u, a);
      ...
      if ("HTML" !== f.nodeName || y(u)) c = p;
        ...
        var h = d(e.ownerDocument),
          g = h.height,
          x = h.width;
        (c.top += p.top - p.marginTop),
        (c.bottom = g + p.top),
        (c.left += p.left - p.marginLeft),
        (c.right = x + p.left);
      }
    }
    ...
    return (
      (c.left += w ? o : o.left || 0),
      (c.top += w ? o : o.top || 0),
      (c.right -= w ? o : o.right || 0),
      (c.bottom -= w ? o : o.bottom || 0),
      c
    );
  }
    ...
    ie = (function () {
      function t(n, r) {
        ...
        V(this, t),
          ...
          Object.keys(Q({}, t.Defaults.modifiers, o.modifiers)).forEach(
            function (e) {
              i.options.modifiers[e] = Q({},
        ...
        arrow: {
          ...
          fn: function (e, n) {
            ...
            return (
              (w = I(M(a[u] - m, w), 0)),
              (e.arrowElement = i),
              (e.offsets.arrow = (G((r = {}), p, B(w)), G(r, d, ""), r)),
              e
            );
          },
          element: "[x-arrow]",
          ...
          fn: function (e, t) {
            ...
            var a,
              ...
              d = (function (e, t) {
                ...
                return {
                  left: f(
                    1 == a % 2 && 1 == l % 2 && !u && t ? r.left - 1 : r.left
                  ),
                  top: p(r.top),
                  bottom: p(r.bottom),
                  right: f(r.right),
            ...
            return (
              (e.attributes = Q({}, x, e.attributes)),
              (e.styles = Q({}, p, e.styles)),
...
(function (e, t) {
  ...
  function p(e, t, n, r, i) {
    ...
    if ((void 0 === r && (r = !0), void 0 === i && (i = !1), "top" === t))
      ...
      1 > d[a] && (e.reach[l] = "start"),
        ...
        t &&
        (d.dispatchEvent(f("ps-scroll-" + l)),
          0 > t ?
          d.dispatchEvent(f("ps-scroll-" + c)) :
          0 < t && d.dispatchEvent(f("ps-scroll-" + p)),
          r && u(e, l)),
        e.reach[l] &&
        (t || i) &&
        d.dispatchEvent(f("ps-" + l + "-reach-" + e.reach[l]));
    })(e, n, o, r, i);
  }
  ...
  function g(e) {
    ...
    r.contains(e.scrollbarXRail) ||
      (a(r, x.element.rail("x")).forEach(function (e) {
          return s(e);
        }),
        r.appendChild(e.scrollbarXRail)),
      r.contains(e.scrollbarYRail) ||
      (a(r, x.element.rail("y")).forEach(function (e) {
          return s(e);
        }),
      ...
      ((e.scrollbarXActive = !0),
        ...
        (e.scrollbarXLeft = d(
          ((e.negativeScrollAdjustment + r.scrollLeft) *
      ...
      v(r, e),
      e.scrollbarXActive ?
      r.classList.add(x.state.active("x")) :
      (r.classList.remove(x.state.active("x")),
        (e.scrollbarXWidth = 0),
        (e.scrollbarXLeft = 0),
        (r.scrollLeft = !0 === e.isRtl ? e.contentWidth : 0)),
      e.scrollbarYActive ?
      r.classList.add(x.state.active("y")) :
      (r.classList.remove(x.state.active("y")),
  ...
  function m(e, t) {
    ...
    return (
      ...
      (t = r(t, e.settings.minScrollbarLength)),
    ...
    L = {
            ...
            ((n.scrollTop -= l),
              ...
              (function (r, i) {
                ...
                if (0 === i) {
                  ...
                  if (
                    (0 === s && 0 > r) ||
                    (s >= e.contentWidth - e.containerWidth && 0 < r)
                  )
                    return !e.settings.wheelPropagation;
                }
                return !0;
      ...
      wheel: function (r) {
        function i(e, t, r) {
          ...
          for (var i = e; i && i !== s;) {
            ...
            if (r && o.overflowY.match(/(scroll|auto)/)) {
              ...
              if (
                0 < a &&
                ((0 < i.scrollTop && 0 > r) || (i.scrollTop < a && 0 < r))
              )
                return !0;
            }
            if (t && o.overflowX.match(/(scroll|auto)/)) {
              ...
              if (
                0 < l &&
                ((0 < i.scrollLeft && 0 > t) || (i.scrollLeft < l && 0 < t))
              )
                return !0;
            }
            i = i.parentNode;
        ...
        function o(n) {
          ...
          if (!i(n.target, a, l)) {
            ...
            r.settings.useBothWheelAxes ?
              ...
              (l ?
                (s.scrollTop -= l * r.settings.wheelSpeed) :
                (s.scrollTop += a * r.settings.wheelSpeed),
                (c = !0)) :
              r.scrollbarXActive &&
              !r.scrollbarYActive &&
              (a ?
                (s.scrollLeft += a * r.settings.wheelSpeed) :
                (s.scrollLeft -= l * r.settings.wheelSpeed),
                (c = !0)) :
              ((s.scrollTop -= l * r.settings.wheelSpeed),
                (s.scrollLeft += a * r.settings.wheelSpeed)),
              g(r),
        ...
        void 0 === window.onwheel ?
          void 0 !== window.onmousewheel && r.event.bind(s, "mousewheel", o) :
          r.event.bind(s, "wheel", o);
      },
      touch: function (r) {
        function i(n, i) {
          var o = t(p.scrollTop),
          ...
          if (l > a) {
            if (
              (0 > i && o === r.contentHeight - r.containerHeight) ||
              (0 < i && 0 === o)
            )
              return 0 === window.scrollY && 0 < i && S.isChrome;
          } else if (
            a > l &&
            ((0 > n && s === r.contentWidth - r.containerWidth) ||
              (0 < n && 0 === s))
          )
            return !0;
          return !0;
        ...
        function c(e, t, r) {
          ...
          for (var i = e; i && i !== p;) {
            ...
            if (r && o.overflowY.match(/(scroll|auto)/)) {
              ...
              if (
                0 < s &&
                ((0 < i.scrollTop && 0 > r) || (i.scrollTop < s && 0 < r))
              )
                return !0;
            }
            if (t && o.overflowX.match(/(scroll|auto)/)) {
              ...
              if (
                0 < a &&
                ((0 < i.scrollLeft && 0 > t) || (i.scrollLeft < a && 0 < t))
              )
                return !0;
            }
            i = i.parentNode;
        ...
        if (S.supportsTouch || S.supportsIePointer) {
          var p = r.element,
            ...
            v = null;
          S.supportsTouch ?
            (r.event.bind(p, "touchstart", l),
              r.event.bind(p, "touchmove", u),
              r.event.bind(p, "touchend", f)) :
            S.supportsIePointer &&
            (window.PointerEvent ?
              (r.event.bind(p, "pointerdown", l),
                r.event.bind(p, "pointermove", u),
                r.event.bind(p, "pointerup", f)) :
              window.MSPointerEvent &&
              (r.event.bind(p, "MSPointerDown", l),
                r.event.bind(p, "MSPointerMove", u),
                r.event.bind(p, "MSPointerUp", f)));
        }
      },
    },
    k = function (e, o) {
      ...
      !0 === this.isRtl && e.classList.add(x.rtl),
        ...
        (this.scrollbarXRail = i(x.element.rail("x"))),
        e.appendChild(this.scrollbarXRail),
        (this.scrollbarX = i(x.element.thumb("x"))),
      ...
      isNaN(this.scrollbarXBottom) ?
        ...
        (this.scrollbarYRail = i(x.element.rail("y"))),
        e.appendChild(this.scrollbarYRail),
        (this.scrollbarY = i(x.element.thumb("y"))),
      ...
      isNaN(this.scrollbarYRight) ?
        ...
        (this.railBorderYWidth =
          d(f.borderTopWidth) + d(f.borderBottomWidth)),
        r(this.scrollbarYRail, {
          display: "block"
        }),
        (this.railYMarginHeight = d(f.marginTop) + d(f.marginBottom)),
        r(this.scrollbarYRail, {
          display: ""
        }),
        ...
        (this.reach = {
          x: 0 >= e.scrollLeft ?
            "start" : e.scrollLeft >= this.contentWidth - this.containerWidth ?
            "end" : null,
          y: 0 >= e.scrollTop ?
            "start" : e.scrollTop >= this.contentHeight - this.containerHeight ?
            "end" : null,
        }),
        (this.isAlive = !0),
